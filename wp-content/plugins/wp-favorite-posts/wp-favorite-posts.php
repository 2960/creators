...
function wpfp_list_most_favorited($limit=5) {
    ...
    if ($results) {
        ...
        foreach ($results as $o):
            ...
            echo "<li>" . get_the_post_thumbnail($o->post_id) . "";
            echo "<a href='".get_permalink($o->post_id)."' title='". $p->post_title ."' class='article_linker'></a><span class'favorited_text'>" . $p->post_title . "</span><span class='red_text'>($o->meta_value)</span>";
            echo "</li>";
        endforeach;
        echo "</ul>";
    }
